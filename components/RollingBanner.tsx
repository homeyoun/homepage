...
export default function RollingBanner() {
  return (
    <div className="relative">
      <Image src={Banner1} alt="Banner" priority className="mx-auto" />
      <div className="grid grid-cols-4 items-center absolute inset-0">
        <section className="ml-16">
          <button className="w-12 h-12  bg-stone-50 rounded-full opacity-40 text-stone-700">
        ...
        <section className="text-stone-50 col-span-2 -ml-32">
          ...
          <button className="mt-14 bg-stone-50 px-20 py-4 opacity-80 text-stone-900">
            신청하기
          </button>
        </section>
